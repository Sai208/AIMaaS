...
CREATE TABLE `prospect_savings` (
  ...
  `Supplier_Compliance_Savings_M` float(16,2) DEFAULT NULL,
  `Invoice_Error_Reductions_Savings_M` float(16,2) DEFAULT NULL,
  `PO_Requisition_Transmission_Savings_M` float(16,2) DEFAULT NULL,
  `Invoice_Receipt_Processing_Savings_M` float(16,2) DEFAULT NULL,
