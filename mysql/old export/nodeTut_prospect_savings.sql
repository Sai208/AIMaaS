...
CREATE TABLE `prospect_savings` (
  ...
  `supplier_compliance_savings` float(16,2) DEFAULT NULL,
  `invoice_error_reductions_savings` float(16,2) DEFAULT NULL,
  `po_requisition_transmission_savings` float(16,2) DEFAULT NULL,
  `invoice_receipt_processing_savings` float(16,2) DEFAULT NULL,
