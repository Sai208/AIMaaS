...
pSavingsColOrder = c('Prospect_ID',	'Enablement_Strategy',	'Supplier_Compliance_Savings_M',	'Invoice_Error_Reduction_Savings_M',	'PO_Requisition_Transmission_Savings_M',	'Invoice_Receipt_Processing_Savings_M')
pTasksTableColOrder = c('Prospect_ID', 'Task_Name', 'Task_Desc','IsDone')
unNecSavingCol = c('Spend_USD', 'PO_Count', 'Invoice_Count', 'Supplier_Compliane_Multiplier', 'Invoice_Error_Multiplier', 'PO_Req_and_Trans_Multiplier', 'Invoice_Receipt_Multiplier')
...
prospectSavings$Supplier_Compliance_Savings_M = prospectSavings$Supplier_Compliance_Multiplier*prospectSavings$Spend_USD/(10^8)
prospectSavings$Invoice_Error_Reduction_Savings_M = prospectSavings$Invoice_Error_Multiplier*prospectSavings$Spend_USD/(10^8)
prospectSavings$PO_Requisition_Transmission_Savings_M = prospectSavings$PO_Req_and_Trans_Multiplier*prospectSavings$PO_Count/(10^8)
prospectSavings$Invoice_Receipt_Processing_Savings_M = prospectSavings$Invoice_Receipt_Multiplier*prospectSavings$Invoice_Count/(10^8)
